...
# [v1] 공통 예외 — 도메인 예외 계층
# pipeline: 공통 인프라
# 구현(요약): 베이스 예외 + LLM/임베딩 rate limit(429)·호출 실패 예외
# 구현일: 2026-06-10 (임베딩 예외 추가: 2026-06-16) | 작성: kys
# ============================================================
...
class EmbeddingCallError(DokkaebiAIError):
    """임베딩 호출 실패(재시도 소진·미구현 provider 등)."""
