...
# TODO(임시): 실기기 들고 실제 이동하며 도착 인증 테스트하려고 전부 10m로 임시 축소
#             (이전엔 이동 없이 테스트하려고 10km로 늘려뒀던 것). 테스트 끝나면 원래 값
#             ({"easy": 150, "normal": 100, "hard": 60})으로 되돌릴 것.
_DIFFICULTY_TRIGGER_M = {"easy": 10, "normal": 10, "hard": 10}
